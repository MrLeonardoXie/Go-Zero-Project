...
import (
	...
	"leonardo/application/article/api/internal/code"
	"leonardo/application/article/api/internal/svc"
	"leonardo/application/article/api/internal/types"
...
func genFileURL(objectKey string) string {
	return fmt.Sprintf("https://leonardo-article.oss-cn-shanghai.aliyuncs.com/%s", objectKey)
}
