...
var (
	...
	cacheLeonardoArticleArticleIdPrefix = "cache:leonardoArticle:article:id:"
)
...
func (m *defaultArticleModel) FindOne(ctx context.Context, id int64) (*Article, error) {
	leonardoArticleArticleIdKey := fmt.Sprintf("%s%v", cacheLeonardoArticleArticleIdPrefix, id)
	var resp Article
	err := m.QueryRowCtx(ctx, &resp, leonardoArticleArticleIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultArticleModel) Insert(ctx context.Context, data *Article) (sql.Result, error) {
	leonardoArticleArticleIdKey := fmt.Sprintf("%s%v", cacheLeonardoArticleArticleIdPrefix, data.Id)
...
func (m *defaultArticleModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheLeonardoArticleArticleIdPrefix, primary)
}
